...
log() is another useful function and it has two arguments, x and base.  When you call the function log()
# you have to specify x (the input value), while base has a default of exp(1). 
